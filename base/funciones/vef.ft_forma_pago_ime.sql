	...
	***********************************/
	...
	if(p_transaccion='VF_FORPA_INS')then
        ...
        begin
            ...
            string_to_array (v_parametros.sw_tipo_venta,',')::VARCHAR[]
...
ALTER FUNCTION vef.ft_forma_pago_ime (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;
