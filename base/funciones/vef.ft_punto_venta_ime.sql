...
BEGIN
	...
	***********************************/
	...
	if(p_transaccion='VF_PUVE_INS')then
      ...
      v_parametros.id_catalogo_canal,
      v_parametros.nombre_amadeus
	...
	***********************************/
      ...
      office_id = v_parametros.office_id,
      id_catalogo = v_parametros.id_catalogo,
      iata_status = v_parametros.iata_status,
      id_catalogo_canal = v_parametros.id_catalogo_canal,
      nombre_amadeus	= v_parametros.nombre_amadeus
