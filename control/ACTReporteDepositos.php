...
/**
*@package pXP
*@file gen-ACTReporteDepositos.php
*@author  (Ismael Valdivia)
*@date 12-03-2021 09:20:00
*@description Clase que recibe los parametros enviados por la vista para mandar a la capa de Modelo
*/
require_once(dirname(__FILE__).'/../reportes/RReporteDepositosXLS.php');

class ACTReporteDepositos extends ACTbase{
    ...
    function listarReporteDepositos()
    {
        ...
        if ($this->objParam->getParametro('tipoReporte') == 'excel_grid' || $this->objParam->getParametro('tipoReporte') == 'pdf_grid') {
            ...
            $this->objFunc = $this->create('MODReporteDepositos');

            $this->res = $this->objFunc->listarReporteDepositos($this->objParam);
        }
		...
		function reporteDepositosExcel()	{

		  $this->objFunc=$this->create('MODReporteDepositos');
			$this->res=$this->objFunc->listarReporteDepositos($this->objParam);

			//obtener titulo del reporte
			$titulo = 'Reporte Depósitos';
			...
			$this->objReporteFormato=new RReporteDepositosXLS($this->objParam);
