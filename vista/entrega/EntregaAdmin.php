...
<script>
    ...
    Phx.vista.EntregaAdmin=Ext.extend(Phx.gridInterfaz,{
            mosttar:'',
            ...
            constructor:function(config){
                ...
                this.tipo_usuario = 'adminEntrega';
                Ext.Ajax.request({
            ...
            successGetVariables : function (response,request) {
                ...
                Phx.vista.EntregaAdmin.superclass.constructor.call(this,request.arguments);
            ...
            onButtonNew : function () {
                Phx.vista.EntregaAdmin.superclass.onButtonNew.call(this);
