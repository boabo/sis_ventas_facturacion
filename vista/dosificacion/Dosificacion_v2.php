...
/**
*@package pXP
*@file gen-Dosificacion_v2.php
*@author  (ivaldivia)
*@date 06-09-2019 12:30:00
...
?>
<script>
Phx.vista.Dosificacion_v2=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.Dosificacion_v2.superclass.constructor.call(this,config);
		this.init();
		this.iniciarEventos();
	...
	Grupos: [
            {
                ...
                items: [{
                                ...
                                bodyStyle: 'padding-right:5px; background:#77C5BB;',
																style:{
    ...
    onButtonEdit:function() {
            Phx.vista.Dosificacion_v2.superclass.onButtonEdit.call(this);
            this.Cmp.tipo_generacion.fireEvent('select');
						this.form.el.dom.firstChild.childNodes[0].style.background = '#77C5BB';
    },
		onButtonNew: function (){
			Phx.vista.Dosificacion_v2.superclass.onButtonNew.call(this);
			this.form.el.dom.firstChild.childNodes[0].style.background = '#77C5BB';
		},
    ...
    loadValoresIniciales:function()
    {
        ...
        Phx.vista.Dosificacion_v2.superclass.loadValoresIniciales.call(this);
    },
    onSubmit : function(o) {

		Phx.vista.Dosificacion_v2.superclass.onSubmit.call(this,o);
	},
    successSave:function(resp){
        ...
        Phx.vista.Dosificacion_v2.superclass.successSave.call(this,resp);
