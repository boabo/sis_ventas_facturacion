...
/**
*@package pXP
*@file gen-SucursalUsuario_v2.php
*@author  (IsmaelValdivia)
*@date 10-09-2019 09:33:37
...
?>
<script>
Phx.vista.SucursalUsuario_v2=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.SucursalUsuario_v2.superclass.constructor.call(this,config);
		this.init();
  ...
  fwidth:350,
    ...
    onButtonEdit:function() {
            Phx.vista.SucursalUsuario_v2.superclass.onButtonEdit.call(this);
            this.form.el.dom.firstChild.childNodes[0].style.background = '#77C5BB';
    },
    onButtonNew: function (){
      Phx.vista.SucursalUsuario_v2.superclass.onButtonNew.call(this);
      this.form.el.dom.firstChild.childNodes[0].style.background = '#77C5BB';
    },

    loadValoresIniciales:function()
    {
        Phx.vista.SucursalUsuario_v2.superclass.loadValoresIniciales.call(this);
        if(this.maestro.hasOwnProperty('id_punto_venta')){
