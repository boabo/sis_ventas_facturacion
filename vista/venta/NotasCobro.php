...
<script>
Phx.vista.NotasCobro=Ext.extend(Phx.gridInterfaz,{
	mosttar:'',
	mgs_user: '<p>Estimado Usuario Registros Anteriores a la Fecha Solo Pueden Ser Consultados </p>',
	solicitarPuntoVenta: true,

	formUrl: '../../../sis_ventas_facturacion/vista/venta/FormNotasCobro.php',
	formClass : 'FormNotasCobro',
    //tipo_factura: 'recibo',
	...
	successGetVariables : function (response,request) {
			...
			Phx.vista.NotasCobro.superclass.constructor.call(this,request.arguments);
 ...
 actualizarSegunTab: function(name, indice){
	...
	preparaMenu: function () {
			...
			Phx.vista.NotasCobro.superclass.preparaMenu.call(this);
		},
		...
		liberaMenu : function(){
				...
				// this.getBoton('completar_pago_2').enable();
				// this.getBoton('ant_estado').enable();
				Phx.vista.NotasCobro.superclass.liberaMenu.call(this);
		},
