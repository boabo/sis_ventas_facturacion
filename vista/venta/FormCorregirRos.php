...
Phx.vista.FormCorregirRos=Ext.extend(Phx.frmInterfaz,{
    ...
    iniciarEventos : function () {
      ...
      /*****************************************************************************/
        ...
        /*Filtramos la lista de paquetes por la sucursal seleccionada*/
    		...
    		// this.Cmp.id_formula.store.baseParams.id_punto_venta = this.data.datos_originales.data.id_punto_venta;
    		/*************************************************************/

        this.Cmp.id_sucursal.store.load({params:{start:0,limit:50},
           callback : function (r) {
           		this.Cmp.id_sucursal.setValue(this.data.datos_originales.data.id_sucursal);
           		if (this.data.objPadre.variables_globales.vef_tiene_punto_venta != 'true') {
           			this.detCmp.id_producto.store.baseParams.id_sucursal = this.Cmp.id_sucursal.getValue();
                }
                this.Cmp.id_sucursal.fireEvent('select',this.Cmp.id_sucursal, this.Cmp.id_sucursal.store.getById(this.data.datos_originales.data.id_sucursal));
      ...
      this.Cmp.id_punto_venta.store.baseParams.id_punto_venta = this.data.datos_originales.data.id_punto_venta;
	        this.Cmp.id_punto_venta.store.load({params:{start:0,limit:this.tam_pag},
	           callback : function (r) {
	                this.Cmp.id_punto_venta.setValue(this.data.datos_originales.data.id_punto_venta);
	           		   this.detCmp.id_producto.store.baseParams.id_punto_venta = this.Cmp.id_punto_venta.getValue();
	                this.Cmp.id_punto_venta.fireEvent('select',this.Cmp.id_punto_venta, this.Cmp.id_punto_venta.store.getById(this.data.datos_originales.data.id_punto_venta));
    ...
    cargarFormaPago : function () {
      ...
      if (this.accionFormulario == 'EDIT') {
        ...
        if (this.data.datos_originales.data.tipo_factura == 'recibo_manual'){
          // this.Cmp.anulado.setValue('VALIDA');
          // this.Cmp.anulado.setVisible(true);
          // this.Cmp.anulado.setDisabled(true);
          this.Cmp.nro_factura.setVisible(true);
          this.Cmp.nro_factura.setDisabled(true);
        }
      ...
      imprimirNota: function(){
         ...
         if (this.data.objPadre.tipo_punto_venta == 'ato') {
                ...
                'id_venta' : this.id_venta ,
   							'id_punto_venta' : this.data.datos_originales.data.id_punto_venta,
  ...
  // },
    ...
    registrarVariasFormasPago: function() {
      ...
      var nro_factura = this.Cmp.nro_factura.getValue();
      var nit = '';
      ...
      var tipo_reci = this.data.datos_originales.data.tipo_factura;
      /****************************************/
