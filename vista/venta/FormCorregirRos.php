...
/**
*@package pXP
*@file    FormCorregirRos.php
*@author  Ismael Valdivia Aranibar
*@date    01/04/2021
*@description Formulario para corregir Recibos Oficiales
*/
header("content-type: text/javascript; charset=UTF-8");
?>

<script>
Phx.vista.FormCorregirRos=Ext.extend(Phx.frmInterfaz,{
    ActSave:'../../sis_ventas_facturacion/control/VentaFacturacion/corregirReciboOficial',
    tam_pag: 10,
    layout: 'fit',
    tabEnter: true,
    autoScroll: false,
    ...
    /*****************************************************************/
	 ...
	 if (this.data.objPadre.tipo_factura == 'manual') {
        ...
        if (this.data.objPadre.variables_globales.codigo_moneda_base=='USD') {
          ...
          this.labelReset = '<div> <span style="vertical-align: middle; font-size:25px; font-weight:bold; color:#1479B8; text-shadow: 3px 0px 0px #000000;"><img src="../../../lib/imagenes/icono_dibu/dibu_edit.png" style="float:left; vertical-align: middle;">CORREGIR</span></div>';
        ...
        Phx.vista.FormCorregirRos.superclass.constructor.call(this,config);
    ...
    iniciarEventos : function () {
      ...
      this.id_moneda_recibo_cambio = this.data.datos_originales.data.id_moneda_venta_recibo;
  ...
  /*****Aqui poniendo el Boton para realizar pagos por WorlPay******/
    ...
    crearStoreFormaPago : function () {
    	...
    	url: '../../sis_ventas_facturacion/control/Cajero/listarInstanciaPagoRecibos',
			id: 'id_medio_pago',
			root: 'datos',
			sortInfo: {
				field: 'id_medio_pago',
    ...
    recuperarInstancias:function(store){
      ...
      if (store[1].data.mop_code == "RANT"){
        ...
        // console.log('component ',this.Cmp.id_venta_recibo_2)
   ...
   // /************************************************************************************************/
    ...
    {
       Phx.vista.FormCorregirRos.superclass.loadValoresIniciales.call(this);
    },
    onReset:function(o){
    ...
    devolverCambio: function(inicio){
    ...
    cargarInstanciaPago: function() {
      ...
      this.Cmp.id_medio_pago.on('select',function(c,r,i) {
        ...
        /*Aqui para editar la cuenta corriente Anticipo*/
        if (this.data.datos_originales.data.id_auxiliar_anticipo != null) {
          this.Cmp.id_auxiliar_anticipo.store.load({params:{start:0,limit:50},
             callback : function (r) {
               if (r.length == 1 ) {
                     ...
                     this.Cmp.id_auxiliar_anticipo.fireEvent('select', this.Cmp.id_auxiliar_anticipo,r[0],0);
                     this.Cmp.id_auxiliar_anticipo.store.baseParams.id_auxiliar = '';
                 }
              }, scope : this
          });
        }
    ...
    saverecibo: function(o){
      ...
      if( i > 0 &&  !this.editorDetail.isVisible()){
           Phx.vista.FormCorregirRos.superclass.onSubmit.call(this,o);
      }
      else{
    ...
    successSave:function(resp)
    {
      ...
      if ('exito_modificacion' in datos_respuesta.ROOT.datos) {
        Ext.Msg.show({
         //title:'<center><h1 style="font-size:20px; color:#0E00B7; text-shadow: -1px -1px 1px rgba(255,255,255,.1), 1px 1px 1px rgba(0,0,0,.5);">Mesaje</h1></center>',
         msg: '<center><b style="font-size:20px; color:#0E00B7; text-shadow: -1px -1px 1px rgba(255,255,255,.1), 1px 1px 1px rgba(0,0,0,.5);">Modificación Exitósa</b></center>',
         width:290,
         height:100,
         buttons: Ext.Msg.OK,
         fn: function () {
