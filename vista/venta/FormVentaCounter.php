...
<script>
    Phx.vista.FormVentaCounter=Ext.extend(Phx.frmInterfaz,{
        ...
        constructor:function(config)
        {
            ...
            Phx.vista.FormVentaCounter.superclass.constructor.call(this,config);
            this.init();
            this.iniciarEventos();
        ...
        onSubmit: function(o) {
            ...
            me.argumentExtraSubmit = { 'json_new_records': JSON.stringify(arra,
                ...
                'nombre_vista':this.mycls};

            if( i > 0 &&  !this.editorDetail.isVisible()){
                Phx.vista.FormVentaCounter.superclass.onSubmit.call(this,o);
            }
            else{
