...
Phx.vista.CorregirFormaPagoRos=Ext.extend(Phx.gridInterfaz,{
 ...
 actualizarSegunTab: function(name, indice){
	...
	preparaMenu: function () {
			...
			Phx.vista.CorregirFormaPagoRos.superclass.preparaMenu.call(this);
		},

		liberaMenu : function(){
				var rec = this.sm.getSelected();
				Phx.vista.CorregirFormaPagoRos.superclass.liberaMenu.call(this);
		},
														...
														handler: function () {
															if (formularioInicio.getForm().isValid()) {
																...
																if (this.variables_globales.vef_tiene_punto_venta === 'true') {
																	...
																	this.store.baseParams.tipo_usuario = this.tipo_usuario;
																	this.store.baseParams.tipo_factura = 'recibos';
																	this.store.baseParams.fecha = this.campo_fecha.getValue().dateFormat('d/m/Y');
...
/************************************************/
    	...
    	var me = this;
           me.objSolForm = Phx.CP.loadWindows(this.formUrl,
                                    '<center><h1 style="font-size:25px; color:#0E00B7; text-shadow: -1px -1px 1px rgba(255,255,255,.1), 1px 1px 1px rgba(0,0,0,.5);"> <img src="../../../lib/imagenes/icono_dibu/dibu_edit.png" style="float:center; vertical-align: middle;"> Corrección de Recibos Oficiales</h1></center>',
                                    {
                                        modal:true,
                                        width:'100%',
                                        height:'100%',
 	 ...
 	 },
   {
    ...
    /*Aumentando para recuperar el auxiliar*/
    {
			config: {
    ...
    {name:'id_moneda_venta_recibo', type: 'numeric'},
