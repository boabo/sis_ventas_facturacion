...
?>
<script>
Phx.vista.ServiciosDosificaciones=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;

    	//llama al constructor de la clase padre
		Phx.vista.ServiciosDosificaciones.superclass.constructor.call(this,config);
		this.init();
	...
	onButtonNew:function () {
		Phx.vista.ServiciosDosificaciones.superclass.onButtonNew.call(this);
	...
	onButtonEdit:function () {
		Phx.vista.ServiciosDosificaciones.superclass.onButtonEdit.call(this);
  ...
  onReloadPage: function(m){
		...
		this.store.baseParams={id_actividad_economica:this.maestro.id_activida_economica};

		this.load({params: {start: 0, limit: 50}});
	},

  loadValoresIniciales: function () {
    this.Cmp.id_actividad_economica.setValue(this.maestro.id_activida_economica);
    Phx.vista.ServiciosDosificaciones.superclass.loadValoresIniciales.call(this);
	},
  ...
  fwidth:450,
    ...
    {name: 'boleto_asociado', type: 'string'},
		{name: 'id_actividad_economica', type: 'string'},
