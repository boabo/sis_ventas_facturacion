...
?>
<script>
Phx.vista.Sucursales_v2=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
    	this.initButtons=[this.cmbEntidad];
		Phx.vista.Sucursales_v2.superclass.constructor.call(this,config);
		this.init();
		this.iniciarEventos();
	...
	onButtonNew: function (){
		Phx.vista.Sucursales_v2.superclass.onButtonNew.call(this);
  ...
  //       var rec = {maestro: this.sm.getSelected().data};
	//
  //           Phx.CP.loadWindows('../../../sis_ventas_facturacion/vista/servicios/Servicios.php',
  ...
  //   },
	...
	onButtonMonedas : function() {
        var rec = {maestro: this.sm.getSelected().data};
            ...
            Phx.CP.loadWindows('../../../sis_ventas_facturacion/vista/sucursal_moneda/SucursalMoneda_v2.php',
                    '<center style="font-size:30px; color:#007a69;"><i style="font-size:35px;" class="fa fa-money" aria-hidden="true"></i> Monedas por Sucursal</center>',
                    {
                        width:800,
                        height:'80%'
                    },
    ...
    onButtonDosificaciones : function() {
        var rec = {maestro: this.sm.getSelected().data};
            Phx.CP.loadWindows('../../../sis_ventas_facturacion/vista/dosificacion/Dosificacion_v2.php',
                    '<center style="color:#007a69; font-size:25px;"><i style="font-size:30px;" class="fa fa-file-text" aria-hidden="true"></i> Dosificaciones por sucursal</center>',
                    {
                        width:'80%',
                        height:'80%'
                    },
    ...
    onButtonPVenta : function() {
        var rec = {maestro: this.sm.getSelected().data};
            ...
            Phx.CP.loadWindows('../../../sis_ventas_facturacion/vista/punto_venta/PuntoVenta_v2.php',
                    '<center style="font-size:30px; color:#007a69;"><i style="font-size:35px;" class="fa fa-plane" aria-hidden="true"></i> Puntos de Venta</center>',
                    {
                        width:1200,
                        height:'90%'
                    },
  ...
  //       },
	...
	loadValoresIniciales:function()
    {
        ...
        Phx.vista.Sucursales_v2.superclass.loadValoresIniciales.call(this);
    },
	bdel:true,
	bsave:true,
    ...
    preparaMenu:function()
    {
      ...
      //  this.getBoton('btnProductos').enable();
        Phx.vista.Sucursales_v2.superclass.preparaMenu.call(this);
    },
    ...
    liberaMenu:function()
    {
        ...
        Phx.vista.Sucursales_v2.superclass.liberaMenu.call(this);
    },
