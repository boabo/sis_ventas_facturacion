...
?>
<script>
    Phx.vista.VentaVendedorApertuta = {
        bsave:false,
        ...
        constructor: function(config) {
            ...
            Phx.vista.VentaVendedorApertuta.superclass.constructor.call(this,config);
        } ,
        arrayDefaultColumHidden:['estado_reg','usuario_ai',
            'fecha_reg','fecha_mod','usr_reg','usr_mod','nro_factura','excento','fecha','cod_control','nroaut'],
        successGetVariables :function (response,request) {
            Phx.vista.VentaVendedorApertuta.superclass.successGetVariables.call(this,response,request);
        ...
        {   var rec = this.sm.getSelected();
            ...
            Phx.vista.VentaVendedorApertuta.superclass.preparaMenu.call(this);
        },
        liberaMenu:function()
        {   this.getBoton('btnImprimir').disable();
            ...
            Phx.vista.VentaVendedorApertuta.superclass.liberaMenu.call(this);
        }
