	...
	cerrarCaja:function(wizard,resp){
		...
		Ext.Ajax.request({
			...
			params:{
				...
				arqueo_moneda_local: (resp.arqueo_moneda_local - resp.monto_inicial),
				arqueo_moneda_extranjera: (resp.arqueo_moneda_extranjera - resp.monto_inicial_moneda_extranjera),
				accion :'cerrar',
