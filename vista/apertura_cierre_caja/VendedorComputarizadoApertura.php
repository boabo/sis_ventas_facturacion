...
?>
<script>
    Phx.vista.VendedorComputarizadoApertura = {
        bsave: false,
        require: '../../../sis_ventas_facturacion/vista/apertura_cierre_caja/VentaVendedorApertuta.php',
        requireclase: 'Phx.vista.VentaVendedorApertuta',
        title: 'Venta',
        nombreVista: 'VentaVendedorApertuta',
        tipo_factura:'computarizada',


        constructor: function(config) {
            this.maestro = config.maestro;
            Phx.vista.VendedorComputarizadoApertura.superclass.constructor.call(this,config);
