...
class RAperturaCierrePDF extends  ReportePDF {
    ...
    function generarReporte() {
        ...
        $this->Cell(100,5,number_format(($this->datos[0]['efectivo_boletos_me'] + $this->datos[0]['efectivo_ventas_me'] + $this->datos[0]['monto_ca_recibo_me'])*$this->datos[0]['tipo_cambio'],2) + ($this->datos[0]['efectivo_boletos_ml'] + $this->datos[0]['efectivo_ventas_ml'] + $this->datos[0]['monto_ca_recibo_ml']).' '.$this->datos[0]['cod_moneda_local'] ,1,1,'C');
        /***********************************************/
