...
class RAperturaCierreUSPDF extends  ReportePDF {
    var $datos;
    var $ancho_hoja;
    var $gerencia;
    var $numeracion;
    ...
    function generarReporte() {
        ...
        $this->Cell(100,5,'IMPORTE EN '. $this->datos[0]['cod_moneda_local'] ,1,1,'C');
        //$this->Cell(50,5,'IMPORTE EN '. $this->datos[0]['cod_moneda_extranjera'] ,1,0,'C');

        $this->Cell(80,5,'Efectivo Venta de Servicios' ,1,0,'L');
        $this->Cell(100,5,number_format($this->datos[0]['efectivo_boletos_ml'],2) ,1,1,'R');
        //$this->Cell(50,5,number_format($this->datos[0]['efectivo_boletos_me'],2) ,1,0,'R');

        $this->Cell(80,5,'Efectivo Otros Cargos' ,1,0,'L');
        $this->Cell(100,5,number_format($this->datos[0]['efectivo_ventas_ml'] + $this->datos[0]['monto_ca_recibo_ml'],2) ,1,1,'R');
        ...
        $this->Cell(100,5,number_format($this->datos[0]['tarjeta_boletos_ml'],2) ,1,1,'R');
        ...
        $this->Cell(100,5,number_format($this->datos[0]['tarjeta_ventas_ml'] + $this->datos[0]['monto_cc_recibo_ml'],2) ,1,1,'R');
        ...
        $this->Cell(100,5,number_format($this->datos[0]['comisiones_ml'],2) ,1,1,'R');
        //$this->Cell(50,5,number_format($this->datos[0]['comisiones_me'],2) ,1,1,'R');

        $this->Cell(80,5,'Cuentas Corrientes Boletos' ,1,0,'L');
        $this->Cell(100,5,number_format($this->datos[0]['cuenta_corriente_boletos_ml'],2) ,1,1,'R');
        ...
        $this->Cell(100,5,number_format($this->datos[0]['cuenta_corriente_ventas_ml'],2) ,1,1,'R');
        //$this->Cell(50,5,number_format($this->datos[0]['cuenta_corriente_ventas_me'],2) ,1,1,'R');

        $this->Cell(80,5,'MCO' ,1,0,'L');
        $this->Cell(100,5,number_format($this->datos[0]['mco_boletos_ml'],2) ,1,1,'R');
        //$this->Cell(50,5,number_format($this->datos[0]['mco_boletos_me'],2) ,1,1,'R');

        $this->Cell(80,5,'Otros' ,1,0,'L');
        $this->Cell(100,5,number_format($this->datos[0]['otros_boletos_ml'],2) ,1,1,'R');
        ...
        $this->Cell(100,5,number_format($total_venta_ml,2) ,1,1,'R');
        //$this->Cell(50,5,number_format($total_venta_me,2) ,1,1,'R');

        $this->Cell(80,5,'TOTAL EFECTIVO' ,1,0,'C');
        $this->Cell(100,5,number_format($this->datos[0]['efectivo_boletos_ml'] + $this->datos[0]['efectivo_ventas_ml'] + $this->datos[0]['monto_ca_recibo_ml'],2) ,1,1,'R');
