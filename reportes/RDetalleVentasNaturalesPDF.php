...
class RDetalleVentasNaturalesPDF extends  ReportePDF {
    var $datos_titulo;
    var $datos_detalle;
    var $ancho_hoja;
    var $gerencia;
    ...
    function Header() {
        ...
        $cabecera = array(25,30,23,19,19,27,45,35,15,15,15);
    ...
    function generarReporte(){
        ...
        $this->SetFont('', '', 7);
        $array = array(20,25,27,17,25,45,45,25,15,20,20);
      ...
      //     $this->SetFont('', 'B', 7);
      //     $this->SetTextColor(0, 66, 66, 0);
      //     $this->Cell('255',3,'TOTALES','B',0,'R');
      //     $this->SetTextColor(100, 35, 0, 31);
      //     $this->Cell('20',3,number_format($totales, 2, ',', '.'),'B',0,'R');
      //     $this->SetTextColor();
      //     $totales = 0;
      //     $this->Ln();
      // }
